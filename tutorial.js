...
(function() {
    ...
    function startApplicationTour() {
        ...
        intro.onbeforechange(function(targetElement) {
            ...
            // --- CAMBIO CLAVE: GESTIÓN DE LA CLASE CSS ---
            if (currentStep === 0) {
                // Al entrar al paso del modal, añadimos la clase
                document.body.classList.add('intro-modal-step-active');
            } else {
                // Para cualquier otro paso, nos aseguramos de que la clase no esté
        ...
        intro.onexit(function() {
            // Limpieza final al salir del tour
            document.body.classList.remove('intro-modal-step-active');
