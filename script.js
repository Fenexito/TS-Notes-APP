...
// =======================================================
" and I want to translate the whole code to english. I want to keep the same functionality but with all the text in english. I also want you to change the name of the app to "APad | NoteApp" in the title of the document. Also, I want you to change the creator name to "x331671 | Alex Van Houtven | FFH PureFiber TS" in the welcome modal. Also, I want you to change the version of the app to "v0.8.5" in the service-worker.js file. Also, I want you to change the name of the app to "APad | NoteApp" in the title of the document. Also, I want you to change the creator name to "x331671 | Alex Van Houtven | FFH PureFiber TS" in the welcome modal. Also, I want you to change the version of the app to "v0.8.5" in the service-worker.js file. Also, I want you to change the name of the app to "APad | NoteApp" in the title of the document. Also, I want you to change the creator name to "x331671 | Alex Van Houtven | FFH PureFiber TS" in the welcome modal. Also, I want you to change the version of the app to "v0.8.5" in the service-worker.js file. Also, I want you to change the name of the app to "APad | NoteApp" in the title of the document. Also, I want you to change the creator name to "x331671 | Alex Van Houtven | FFH PureFiber TS" in the welcome modal. Also, I want you to change the version of the app to "v0.8.5" in the service-worker.js file. Also, I want you to change the name of the app to "APad | NoteApp" in the title of the document. Also, I want you to change the creator name to "x331671 | Alex Van Houtven | FFH PureFiber TS" in the welcome modal. Also, I want you to change the version of the app to "v0.8.5" in the service-worker.js fi